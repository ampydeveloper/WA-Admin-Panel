  ...
  /**
    ...
    public function updateCustomer(Request $request)
    {
        ...
        try {
            ...
            $customerDetails->user_image = isset($request->user_image)? $request->user_image:null;
   ...
   */
    ...
    public function updateManager(Request $request) {
        $validator = Validator::make($request->all(), [
            ...
            'manager_first_name' => 'required',
            'manager_last_name' => 'required',
            'manager_email' => 'required|email|unique:users,email.'. $request->customer_id,
            'manager_phone' => 'required',
            'manager_address' => 'required',
            'manager_city' => 'required',
            'manager_province' => 'required',
        ...
        try {
            ...
            $manager->prefix = $request->manager_prefix;
            ...
            $manager->user_image = isset($request->manager_image)? $request->manager_image:null;

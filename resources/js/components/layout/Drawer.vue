...
<span v-html="subItem.icon"> </span>
   ...
   <v-list v-if="isDriver">
       ...
       <v-list v-if="isMechanic">
          <v-list-group
            v-for="item in mechanicitems"
            :key="item.title"
            v-model="item.active"
            :prepend-icon="item.action"
            no-action
...
export default {
    ...
    items: [
      {
        ...
        items: [
          ...
          },
          {
            title: "Pickups",
            url: "/admin/jobs",
            icon: "<img src='/images/briefcase.svg' />",
          },
          {
            title: "Dispatch",
            url: "/admin/dispatches",
            icon: "<img src='/images/package.svg' />",
          },
          {
            title: "Services",
            url: "/admin/services",
            icon: "<img src='/images/grid.svg' />",
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            title: "Haulers",
            url: "/admin/hauler",
            icon: "<img src='/images/user-plus.svg' />",
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            title: "Dispatchers",
            url: "/admin/manager",
            icon: "<img src='/images/user-check.svg' />",
          },
          {
            title: "Drivers",
            url: "/admin/truckdrivers",
            icon: "<img src='/images/users.svg' />",
          },
          {
            title: "Mechanic",
            url: "/admin/mechanic",
        ...
        items: [
          {
            ...
            icon: "<img src='/images/book-open.svg' />",
          },
          {
            title: "Reports",
            url: "/admin/reports",
            icon: "<img src='/images/file-text.svg' />",
          },
        ],
      },
      {
  ...
  computed: {
    ...
    computedItems() {
      ...
      } else if (currentUser.data.user.role_id == 9) {
        return this.mechanicitems.map(this.mapItem);
      } else {
        return this.items.map(this.mapItem);
      }
    },

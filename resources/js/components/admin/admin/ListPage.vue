<template>
      ...
      <v-col
          ...
          md="12"
        >
          <router-link to="/admin/admin/add" class="nav-item nav-link"> <plus-circle-icon size="1.5x" class="custom-class"></plus-circle-icon></router-link>
    ...
    <template v-slot:default>
      ...
      <tbody>
        <tr v-for="item in managers" :key="item.name">
          ...
          <td> 
            <router-link :to="'/admin/admin/view/' + item.id" class="nav-item nav-link"><user-icon size="1.5x" class="custom-class"></user-icon></router-link>
              <router-link :to="'/admin/admin/edit/' + item.id" class="nav-item nav-link"><edit-icon size="1.5x" class="custom-class"></edit-icon></router-link>
